...
export const AuthContext = createContext<IUseAuth>({
  ...
  userCurrent: null,
  vip: null,
  register: function (registerRequest: RegisterRequest, redirect: (href: string) => void): Promise<void> {
    throw new Error("Function not implemented.");
  },
  login: function (loginRequest: LoginRequest, redirect: (
    href: string) => void): Promise<void> {
    throw new Error("Function not implemented.");
  },
